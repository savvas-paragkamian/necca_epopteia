...
Ο αγωγός χρησιμοποιεί κορυφαία ~3,6 GiB RAM και εκτελείται σε ~6,5 λεπτά
με έναν πυρήνα. Βεβαιωθείτε ότι το podman machine έχει επαρκή περιθώρια:
...
#### Χρήση πόρων (benchmark, μονός πυρήνας, πλήρης εκτέλεση από μηδέν)

| Μετρική | Τιμή |
|---------|------|
| Χρόνος ρολογιού τοίχου | 6 λεπτά 25 δευτ. |
| Χρόνος CPU χρήστη | 6 λεπτά 6 δευτ. |
| Μέγιστη RAM (RSS) | 3,57 GiB |
| Αποτύπωμα μνήμης (peak footprint) | 189 MiB |

Ο χρόνος χρήστη ≈ χρόνος ρολογιού υποδηλώνει μονοπύρηνη εκτέλεση.
Χρησιμοποιήστε `tar_make(par_type = "future")` για παράλληλα Extract targets.
